...
The work proposes a novel graph-based framework **SO**cial graph with **M**ulti-head attention and **P**ublisher information and news **S**tatistics **Net**work (SOMPS-Net) that comprises of two components -- Social Interaction Graph(SIG) and Publisher and News Statistics(PNS). The perfomance of the framework was tested on the Fake Health News [dataset] (https://arxiv.org/abs/2002.00837).
